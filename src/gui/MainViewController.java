...
public class MainViewController implements Initializable {
	...
	public void onMenuItemClienteAction() {
		carregaView2("/gui/ListaCliente.fxml");
	}
	...
	public synchronized void carregaView2(String caminhoView) {
		...
		try {
			...
			//TESTE
			ListaClienteController controlador = carregador.getController();
			
			//Inejata a dependência do ClienteService no controlador
